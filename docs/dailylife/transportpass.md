...
### 补充（From 高松灯）
十堰公交支持 **交通联合** 带有 **交通联合** 标志的各地交通卡都可以刷（统一显示为异地卡，不优惠） 因此懒得办希望卡可以在手机钱包中开通任意带 **交通联合** 标志的电子NFC卡使用
对于打的或自驾途径江苏路的学生，建议周日上学时绕行 **黄石路** 隧道，否则可能会因堵车耽误行程
***如果没自信了，可以多打几次的，一定会有司机夸你是学霸***
